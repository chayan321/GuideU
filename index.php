...
<html>
  ...
  crossorigin="anonymous"></script>
    ...
    <body>
	            ...
	            <li class="tabs" id="sub">
	            	...
	            	<ul id="subjects-list">
	            		...
	            		<li id="science">
	            			Science
	            			<ul id="science-list">
	            				<form action="assets/subjects.php" method="post">
                                    <input type="hidden" id="active_option" name="active_option" value="physics" />
                                    <li><input type="submit" value="Physics" /></li>
                                </form>
	            				<li>Chemistry</li>
	            				<li>Mathematics</li>
	            			</ul>
        ...
        <main>
        	<div class="width-20">hgghjdfddddddddd</div>
        	<div class="width-50">
        		  <div class="db1">
